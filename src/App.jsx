...
const App = () => {
  const [burgerStack, setBugerStack] = useState([]);
  ...
  const addToBurger = (newIngredient) => {
    ...
    setBugerStack(updatedBurgerStack)
  }
  ...
  return (
    <main>
      ...
      <section>
        ...
        <BurgerStack removeFromBurger = {removeFromBurger} burgerStack = {burgerStack} availableIngredients = {availableIngredients}/>
      </section>
    </main>
  );
};
